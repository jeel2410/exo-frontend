...
// Most popular countries first for better user experience
...
// Less popular countries sorted alphabetically
...
// Export the combined array with popular countries first
export const countries: CountryData[] = [...popularCountries, ...otherCountries];
